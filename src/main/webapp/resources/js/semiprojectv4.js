...
joinbtn?.addEventListener('click', ()=>{
    ...
    else if (joinfrm.checkuid.value === 'no') alert('아이디 중복 체크 하세요!!'); //아이디 중보 체크

    else {
        joinfrm.zipcode.value = joinfrm.zip1.value+'-'+joinfrm.zip1.value; // joinme 에 input으로 모여있는 곳에 보내진다.
